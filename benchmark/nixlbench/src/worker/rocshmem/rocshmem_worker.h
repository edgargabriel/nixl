...
#ifndef NIXL_BENCHMARK_NIXLBENCH_SRC_WORKER_ROCSHMEM_ROCSHMEM_WORKER_H
#define NIXL_BENCHMARK_NIXLBENCH_SRC_WORKER_ROCSHMEM_ROCSHMEM_WORKER_H
...
class xferBenchRocshmemWorker: public xferBenchWorker {
    private:
    ...
    public:
        xferBenchRocshmemWorker();
        ~xferBenchRocshmemWorker() override;
    ...
    private:
        ...
        initBasicDescRocshmem(size_t buffer_size, int mem_dev_id);
        void
        cleanupBasicDescRocshmem(xferBenchIOV &iov);
};
#endif

#endif // NIXL_BENCHMARK_NIXLBENCH_SRC_WORKER_ROCSHMEM_ROCSHMEM_WORKER_H
